...
| 4e | Both demos build and run; `git`-less diff of generated `.cpp` reviewed by hand; latency-model migration banner appears in a project with a hand-written model. |
