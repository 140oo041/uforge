...
module Memory1 (
    ...
    input  logic rst,
    // in: MemRequest
    input  logic MemRequest_valid,
    input  logic [31:0] MemRequest_addr,
    input  logic [31:0] MemRequest_value,
    // in: Out1ToMemory1Event
    input  logic Out1ToMemory1Event_valid
