...
class R3 : public microarch::Router {
  public:
    explicit R3(microarch::Scheduler& scheduler)
        : microarch::Router("R3", scheduler, 1) {}
...
// === ISS-AUTHORED:END ===
    ...
    // connection riding R3); unassigned wires use flat().
